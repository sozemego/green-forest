...
export type ResourceActor = Interpreter<ResourceContext, ResourceSchema, ResourceAction>;
...
export type ModifyResourcesAction = {
	type: typeof RESOURCE_ACTION.MODIFY_RESOURCES, resource: string, change: number
}

export type ResourceAction = ModifyResourcesAction

export let resourceMachine = Machine<ResourceContext, ResourceSchema, ResourceAction>({
	id: "resource",
